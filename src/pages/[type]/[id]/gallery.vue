  ...
  <div>
    ...
    >
      <div class="modal-gallery universal-labels">
        ...
        >
          <IconStar fill="currentColor" aria-hidden="true" />
          Unfeature image
        </button>
          ...
          <div class="controls">
            <div class="buttons">
              ...
              <button class="circle-button" @click="zoomedIn = !zoomedIn">
                <IconArrowsMaximize v-if="!zoomedIn" aria-hidden="true" />
                <IconArrowsMinimize v-else aria-hidden="true" />
              </button>
              <button
    ...
    <div v-if="currentMember" class="card header-buttons">
      <FileInput
        ...
        class="iconified-button brand-button"
        :disabled="!currentMember?.permissions.EDIT_DETAILS"
        @change="handleFiles"
      >
        <IconUpload aria-hidden="true" />
      </FileInput>
      <span class="indicator">
        <IconInfoCircle aria-hidden="true" /> Click to choose an image or drag one onto this page
      </span>
      <DropArea
        :accept="acceptFileTypes"
        :disabled="!currentMember?.permissions.EDIT_DETAILS"
      ...
      <div v-for="(item, index) in project.gallery" :key="index" class="card gallery-item">
        ...
        <div class="gallery-bottom">
          <div class="gallery-created">
            <IconCalendar aria-hidden="true" aria-label="Date created" />
...
<script setup>
import { IconPlus, IconCalendar, IconEdit, IconTrash, IconDeviceFloppy, IconStar, IconX, IconArrowRight, IconArrowLeft, IconExternalLink, IconArrowsMaximize, IconArrowsMinimize, IconUpload,IconInfoCircle, IconPhoto, IconSwitchHorizontal } from "@tabler/icons-vue";
import ConfirmModal from "~/components/ui/ModalConfirm.vue";
...
const description = `View ${props.project.gallery.length} images of ${props.project.title} on Vanilla Tyme.`;
