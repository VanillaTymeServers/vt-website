<template>
  <div>
    <ModalConfirm
      ref="modal_remove"
      title="Are you sure you want to remove this shop from the organization?"
      description="If you proceed, this shop will no longer be managed by the organization."
    ...
    <Card>
      ...
      <span class="label">
        ...
        <span class="label__description">
          Enter the Minecraft username of the person you'd like to invite to be a member of this shop.
        </span>
      </span>
      <div class="input-group">
        <input
          ...
          :disabled="!props.currentMember?.permissions.MANAGE_INVITES"
      ...
      <div class="adjacent-input">
        <span class="label">
          <span class="label__title">Leave shop</span>
          <span class="label__description"> Remove yourself as a member of this shop. </span>
        </span>
        <button
          ...
          :title="
            props.currentMember?.is_owner
              ? 'You cannot leave the shop if you are the owner!'
              : ''
          "
          @click="leaveProject()"
        >
        ...
        <div class="info">
          ...
          <div class="text">
            <nuxt-link :to="'/user/' + member.user.username" class="name">
              <p>{{ member.name }}</p>
              <IconCrown v-if="member.is_owner" v-tooltip="'Shop owner'" />
            </nuxt-link>
            <p>{{ member.role }}</p>
          </div>
        </div>
      ...
      <div class="content">
        <div class="adjacent-input">
          <label :for="`member-${allTeamMembers[index].user.username}-role`">
            ...
            <span class="label__description">
              The title of the role that this member plays for this shop.
            </span>
          </label>
          <input
            ...
            type="text"
            :disabled="!props.currentMember?.permissions.EDIT_MEMBER"
          />
        </div>
        <template v-if="!member.is_owner">
          ...
          <div v-if="allTeamMembers[index]" class="permissions">
            <Checkbox
              :model-value="member.permissions.UPLOAD_VERSION"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
            ...
            />
            <Checkbox
              :model-value="member.permissions.DELETE_VERSION"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
            ...
            />
            <Checkbox
              :model-value="member.permissions.EDIT_DETAILS"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
                !props.currentMember?.permissions.EDIT_DETAILS
              "
              label="Edit details"
              @update:model-value="(value) => allTeamMembers[index].permissions.EDIT_DETAILS = value"
            />
            <Checkbox
              :model-value="member.permissions.EDIT_BODY"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
                !props.currentMember?.permissions.EDIT_BODY
              "
              label="Edit body"
              @update:model-value="allTeamMembers[index].permissions ^= EDIT_BODY"
            />
            <Checkbox
              :model-value="member.permissions.MANAGE_INVITES"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
            ...
            />
            <Checkbox
              :model-value="member.permissions.REMOVE_MEMBER"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
            ...
            />
            <Checkbox
              :model-value="member.permissions.EDIT_MEMBER"
              :disabled="!props.currentMember?.permissions.EDIT_MEMBER"
              label="Edit member"
              @update:model-value="allTeamMembers[index].permissions ^= EDIT_MEMBER"
            />
            <Checkbox
              :model-value="member.permissions.DELETE_PROJECT"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
            ...
            />
            <Checkbox
              :model-value="member.permissions.VIEW_ANALYTICS"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
      ...
      <div class="content">
        <div class="adjacent-input">
          <label :for="`member-${allOrgMembers[index].user.username}-override-perms`">
            ...
            <span class="label__description">
              ...
              monetization weights to this user on the shop.
            </span>
          </label>
          <input
        ...
        <div class="adjacent-input">
          <label :for="`member-${allOrgMembers[index].user.username}-monetization-weight`">
            ...
            <span class="label__description">
              ...
              this shop's revenue goes to this member.
            </span>
          </label>
          <input
        ...
        <template v-if="!member.is_owner">
          ...
          <div class="permissions">
            ...
            />
            <Checkbox
              :model-value="member.permissions.VIEW_PAYOUTS"
              :disabled="
                !props.currentMember?.permissions.EDIT_MEMBER ||
...
import { IconArrowsRightLeft, IconCheck, IconUsers, IconChevronDown, IconDeviceFloppy, IconUserPlus, IconUserMinus, IconBuilding, IconCrown, IconUserX } from "@tabler/icons-vue";
import Avatar from "~/components/modrinth/ui/base/Avatar.vue";
import Badge from "~/components/modrinth/ui/base/Badge.vue";
import Card from "~/components/modrinth/ui/base/Card.vue";
...
const onAddToOrg = useClientTry(async () => {
  ...
  addNotification({
    group: "main",
    title: "Shop transferred",
    text: "Your shop has been transferred to the organization.",
    type: "success",
  });
});
...
const onRemoveFromOrg = useClientTry(async () => {
  ...
  addNotification({
    group: "main",
    title: "Shop removed",
    text: "Your shop has been removed from the organization.",
    type: "success",
  });
});
