			...
			<div class="flex flex-col justify-between gap-3 lg:flex-row">
				...
				<div class="flex flex-col justify-end gap-2 sm:flex-row lg:flex-shrink-0">
					<div class="flex flex-col gap-2 sm:flex-row">
						...
						>
							<span class="flex flex-row gap-2 align-middle font-semibold text-secondary">
								<IconSortAscending v-if="selected === 'Oldest'" class="size-4 flex-shrink-0" />
								<IconSortDescending v-else class="size-4 flex-shrink-0" />
					...
					<ButtonStyled color="orange" class="w-full sm:w-auto">
						...
						>
							<IconScale class="size-4 flex-shrink-0" />
							<span class="hidden sm:inline">Moderate</span>
...
import { IconFilter, IconScale, IconSearch, IconSortAscending, IconSortDescending, IconX } from '@tabler/icons-vue'
