    ...
    <div>
        <Modal ref="editLinksModal" header="Edit links">
            <div class="universal-modal links-modal">
                <p>
                    Any links you specify below will be overwritten on each of
                    the selected projects. Any you leave blank will be ignored.
                    You can clear a link from all selected projects using the
                    trash can button.
                </p>
                <section class="links">
                    <label
                    ...
                    <div class="input-group shrink-first">
                        ...
                        <button
                            ...
                            @click="
                                editLinks.issues.clear = !editLinks.issues.clear
                            "
                        >
                            <IconTrash />
                        </button>
                    ...
                    <div class="input-group shrink-first">
                        ...
                        <button
                            ...
                            @click="
                                editLinks.source.clear = !editLinks.source.clear
                            "
                        >
                            <IconTrash />
                        </button>
                    ...
                    <div class="input-group shrink-first">
                        ...
                        <button
                            ...
                            @click="
                                editLinks.wiki.clear = !editLinks.wiki.clear
                            "
                        >
                            <IconTrash />
                        </button>
                ...
                <ul>
                    ...
                    >
                        <strong
                            >and
                            {{ selectedProjects.length - 3 }} more...</strong
                        >
                    </li>
                </ul>
                <Checkbox
        ...
        <section class="universal-card">
            <div class="header__row">
                <h2 class="header__title text-2xl">Shops</h2>
            ...
            <p v-if="projects.length < 1">
                You don't have any projects yet. Click the green button above to
                begin.
            </p>
            <template v-else>
                <p>
                    You can edit multiple projects at once by selecting them
                    below.
                </p>
                <div class="input-group">
                    <button
                ...
                <div class="grid-table">
                    ...
                    >
                        <div>
                            <Checkbox
                                :disabled="
                                    (project.permissions & EDIT_DETAILS) ===
                                    EDIT_DETAILS
                                "
                                :model-value="
...
export default defineNuxtComponent({
    ...
    data() {
        return {
            projects: this.user?.projects
                ? this.updateSort(this.user.projects, "Name")
                : [],
            versions: [],
            selectedProjects: [],
            sortBy: "Name",
    ...
    methods: {
        ...
        updateSort(projects, sort, descending) {
            ...
            let sortedArray = projects.slice();
            switch (sort) {
                case "Name":
        ...
        async bulkEditLinks() {
            try {
                const baseData = {
                    ...
                    wiki_url: this.editLinks.wiki.clear
                        ? null
                        : this.editLinks.wiki.val.trim(),
