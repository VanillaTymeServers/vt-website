<template>
  <div class="flex flex-col gap-3">
    <h2 class="text-lg m-0">Creators</h2>
        ...
        <div class="flex flex-col">
          <span class="flex flex-row flex-nowrap items-center gap-1 group-hover:underline">
            ...
            <IconCrown
              ...
              v-tooltip='() => "Shop owner"'
              class="text-brand-orange"
            />
            <IconExternalLink v-if="linkTarget === '_blank'" />
          </span>
...
import { IconCrown, IconExternalLink, IconBuilding } from '@tabler/icons-vue'
