<template>
	<div class="flex flex-col gap-3 mb-3">
		<div class="flex flex-wrap justify-between gap-2">
			...
			<ButtonStyled v-if="openModal" :color="createItemButtonSecondary ? 'standard' : 'green'">
	...
	>
		...
		<template v-for="(version, index) in currentInventory" :key="index">
			<!-- Row divider -->
			<div
						...
						<div class="flex flex-row flex-wrap items-center gap-1 xl:contents">
							<div class="flex items-center">
								<div class="flex flex-wrap gap-1">
									<TagItem
										v-for="gameVersion in formatInventoryForDisplay(
										...
										class="z-[1]"
										:action="
											() => itemFilters?.toggleFilters('gameVersion', version.game_versions)
										"
									>
										{{ gameVersion }}
									</TagItem>
...
import { IconCalendar, IconDownload, IconPlus, IconStar } from '@tabler/icons-vue'
import AutoLink from '../base/AutoLink.vue'
import ButtonStyled from '../base/ButtonStyled.vue'
import FormattedTag from '../base/FormattedTag.vue'
import Pagination from '../base/Pagination.vue'
import TagItem from '../base/TagItem.vue'
import InventoryFilterControl from '../inventory/InventoryFilterControl.vue'
...
const props = withDefaults(
	defineProps<{
		...
		inventory: VersionWithDisplayUrlEnding[]
...
const versionFilters: Ref<InstanceType<typeof InventoryFilterControl> | null> = ref(null)
