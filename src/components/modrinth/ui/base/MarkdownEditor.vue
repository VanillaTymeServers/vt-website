<template>
  <Modal ref="linkModal" header="Insert link">
    <div class="modal-insert">
      ...
      <div class="input-group push-right">
        <Button :action="() => linkModal?.hide()"><IconX /> Cancel</Button>
        <Button
          color="primary"
  ...
  <Modal ref="imageModal" header="Insert image">
    <div class="modal-insert">
      ...
      <div class="input-group push-right">
        <Button :action="() => imageModal?.hide()"><IconX /> Cancel</Button>
        <Button
          color="primary"
  ...
  <Modal ref="videoModal" header="Insert YouTube video">
    <div class="modal-insert">
      ...
      <div class="input-group push-right">
        <Button :action="() => videoModal?.hide()"><IconX /> Cancel</Button>
        <Button
          color="primary"
          :disabled="linkValidationErrorMessage || !linkUrl"
          :action="
...
import { IconH1, IconH2, IconH3, IconBold, IconItalic, IconScanEye, IconStrikethrough, IconCode, IconList, IconListNumbers, IconBlockquote, IconLink, IconPhoto, IconBrandYoutube, IconAlignLeft, IconPlus, IconX, IconUpload, IconInfoCircle  } from '@tabler/icons-vue'
import { markdownCommands, modrinthMarkdownEditorKeymap } from '~/utils/codemirror.ts'
import { renderHighlightedString } from '~/utils/highlight.ts'
import Modal from '~/components/modrinth/ui/modal/Modal.vue'
import Button from '~/components/modrinth/ui/base/Button.vue'
import Toggle from '~/components/modrinth/ui/base/Toggle.vue'
import FileInput from '~/components/modrinth/ui/base/FileInput.vue'
...
const BUTTONS: ButtonGroupMap = {
  headings: {
    ...
    hideOnMobile: false,
    buttons: [
      composeCommandButton('Heading 1', IconH1, markdownCommands.toggleHeader),
      composeCommandButton('Heading 2', IconH2, markdownCommands.toggleHeader2),
      composeCommandButton('Heading 3', IconH3, markdownCommands.toggleHeader3),
    ],
  },
  stylizing: {
    display: true,
    hideOnMobile: false,
    buttons: [
      composeCommandButton('Bold', IconBold, markdownCommands.toggleBold),
      composeCommandButton('Italic', IconItalic, markdownCommands.toggleItalic),
      composeCommandButton(
        'Strikethrough',
        IconStrikethrough,
        markdownCommands.toggleStrikethrough,
      ),
      composeCommandButton('Code', IconCode, markdownCommands.toggleCodeBlock),
      composeCommandButton('Spoiler', IconScanEye, markdownCommands.toggleSpoiler),
    ],
  },
  lists: {
    display: true,
    hideOnMobile: false,
    buttons: [
      composeCommandButton('Bulleted list', IconList, markdownCommands.toggleBulletList),
      composeCommandButton('Ordered list', IconListNumbers, markdownCommands.toggleOrderedList),
      composeCommandButton('Quote', IconBlockquote, markdownCommands.toggleQuote),
    ],
  },
  components: {
    display: true,
