...
const selectedChip = computed({
  ...
  set(v: string) {
    if (v === 'Technical Review') router.push('/moderation/technical-review')
    else if (v === 'Reports') router.push('/moderation/reports')
    else if (v === 'News') router.push('/moderation/news')
