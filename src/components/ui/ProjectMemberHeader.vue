  ...
  >
      ...
      <div class="header__title">
        ...
        <div class="checklist">
          ...
          <div class="checklist__items">
            ...
            >
              <IconCheck v-if="!nag.condition" />
              <IconAsterisk v-else-if="nag.status === 'required'" />
              <IconBulb v-else-if="nag.status === 'suggestion'" />
              <IconScale v-else-if="nag.status === 'review'" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div v-if="!collapsed" class="grid-display width-16">
      ...
      >
        ...
        >
          {{ nag.link.title }}
          <IconChevronRight class="featured-header-chevron" aria-hidden="true" />
        </NuxtLink>
        <button
...
import { IconChevronRight, IconChevronDown, IconCheck, IconX, IconAsterisk, IconBulb, IconScale, IconSend } from "@tabler/icons-vue";
