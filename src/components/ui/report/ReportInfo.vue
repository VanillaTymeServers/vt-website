<template>
  <div class="report">
    ...
    <div v-else-if="report.item_type === 'version'" class="item-info">
      ...
      >
        <div class="backed-svg" :class="{ raised: raised }"><IconGitCommit /></div>
    ...
    <div v-else class="item-info">
      <div class="backed-svg" :class="{ raised: raised }"><IconHelp /></div>
    ...
    <div class="reporter-info">
      <IconFlag class="inline-svg" /> Reported by
...
import { IconFlag, IconHelp, IconGitCommit} from "@tabler/icons-vue"
